...
export type SyntaxNode = ArgumentsNode | ArrayNode | AttributeNode | ConstructorNode | DictionaryNode | IdentifierNode | PairNode | PropertyNode | ResourceNode | SectionNode | UnnamedNode<"("> | UnnamedNode<")"> | UnnamedNode<","> | UnnamedNode<":"> | UnnamedNode<"="> | UnnamedNode<"["> | UnnamedNode<"]"> | CommentNode | FalseNode | FloatNode | IntegerNode | NullNode | PathNode | StringNode | TrueNode | UnnamedNode<"{"> | UnnamedNode<"}"> | ErrorNode;
...
export interface ConstructorNode extends NamedNodeBase {
    type: typeof SyntaxType.Constructor;
}
...
export interface PropertyNode extends NamedNodeBase {
    type: typeof SyntaxType.Property;
}
export interface ResourceNode extends NamedNodeBase {
    type: typeof SyntaxType.Resource;
}
export interface SectionNode extends NamedNodeBase {
    type: typeof SyntaxType.Section;
}
...
export interface PathNode extends NamedNodeBase {
    type: typeof SyntaxType.Path;
}
