...
type PickType<Node, T extends string> = Node extends {
    type: T;
} ? Node : never;
...
export declare const SyntaxType: {
    ...
    readonly AttributeCall: "attribute_call";
    readonly AttributeSubscript: "attribute_subscript";
    readonly AugmentedAssignment: "augmented_assignment";
    readonly AwaitExpression: "await_expression";
    readonly BaseCall: "base_call";
    readonly BinaryOperator: "binary_operator";
    readonly Body: "body";
    readonly BreakStatement: "break_statement";
    readonly Call: "call";
    readonly ClassBody: "class_body";
    readonly ClassDefinition: "class_definition";
    readonly ClassNameStatement: "class_name_statement";
    readonly ConditionalExpression: "conditional_expression";
    readonly ConstStatement: "const_statement";
    readonly ConstructorDefinition: "constructor_definition";
    readonly ContinueStatement: "continue_statement";
    readonly DefaultParameter: "default_parameter";
    readonly Dictionary: "dictionary";
    readonly ElifClause: "elif_clause";
    readonly ElseClause: "else_clause";
    readonly EnumDefinition: "enum_definition";
    readonly Enumerator: "enumerator";
    readonly EnumeratorList: "enumerator_list";
    readonly ExportVariableStatement: "export_variable_statement";
    readonly ExpressionStatement: "expression_statement";
    readonly ExtendsStatement: "extends_statement";
    readonly ForStatement: "for_statement";
    readonly FunctionDefinition: "function_definition";
    readonly GetBody: "get_body";
    readonly GetNode: "get_node";
    readonly Getter: "getter";
    readonly Identifier: "identifier";
    readonly IfStatement: "if_statement";
    readonly InferredType: "inferred_type";
    readonly Lambda: "lambda";
    readonly MatchBody: "match_body";
    readonly MatchStatement: "match_statement";
    readonly Name: "name";
    readonly NodePath: "node_path";
    readonly OnreadyVariableStatement: "onready_variable_statement";
    readonly Pair: "pair";
    readonly Parameters: "parameters";
    readonly ParenthesizedExpression: "parenthesized_expression";
    readonly PassStatement: "pass_statement";
    readonly PatternBinding: "pattern_binding";
    readonly PatternGuard: "pattern_guard";
    readonly PatternSection: "pattern_section";
    readonly RegionStart: "region_start";
    readonly RemoteKeyword: "remote_keyword";
    readonly ReturnStatement: "return_statement";
    readonly SetBody: "set_body";
    readonly Setget: "setget";
    readonly Setter: "setter";
    readonly SignalStatement: "signal_statement";
    readonly Source: "source";
    readonly String: "string";
    readonly StringName: "string_name";
    readonly Subscript: "subscript";
    readonly SubscriptArguments: "subscript_arguments";
    readonly Type: "type";
    readonly TypedDefaultParameter: "typed_default_parameter";
    readonly TypedParameter: "typed_parameter";
    readonly UnaryOperator: "unary_operator";
    readonly VariableStatement: "variable_statement";
    readonly VariadicParameter: "variadic_parameter";
    readonly WhileStatement: "while_statement";
    readonly BreakpointStatement: "breakpoint_statement";
    readonly Comment: "comment";
    readonly EscapeSequence: "escape_sequence";
    readonly False: "false";
    readonly Float: "float";
    readonly Integer: "integer";
    readonly LineContinuation: "line_continuation";
    readonly Null: "null";
    readonly PatternOpenEnding: "pattern_open_ending";
    readonly RegionEnd: "region_end";
    readonly RegionLabel: "region_label";
    readonly StaticKeyword: "static_keyword";
    readonly True: "true";
};
export type SyntaxType = typeof SyntaxType[keyof typeof SyntaxType];
export type UnnamedType = "()" | "value" | "!" | "!=" | "\"" | "#region" | "$" | "%" | "%=" | "&" | "&\"" | "&&" | "&=" | "(" | ")" | "*" | "**" | "**=" | "*=" | "+" | "+=" | "," | "-" | "-=" | "->" | "." | "..." | "/" | "/=" | ":" | ":=" | ";" | "<" | "<<" | "<<=" | "<=" | "=" | "==" | ">" | ">=" | ">>" | ">>=" | "@" | "[" | "]" | "^" | "^\"" | "^=" | "_init" | "and" | "as" | "await" | "break" | "class" | "class_name" | "const" | "continue" | "elif" | "else" | "enum" | "export" | "extends" | "for" | "func" | "get" | "if" | "in" | "is" | "master" | "mastersync" | "match" | "not" | "onready" | "or" | "pass" | "puppet" | "puppetsync" | "remote" | "remotesync" | "return" | "set" | typeof SyntaxType.Setget | "signal" | "var" | "when" | "while" | "{" | "|" | "|=" | "||" | "}" | "~";
export type TypeString = SyntaxType | UnnamedType;
export type SyntaxNode = AttributeExpressionNode | CompoundStatementNode | ExpressionNode | ParametersNode | PatternNode | PrimaryExpressionNode | UnnamedNode<"()"> | AnnotationNode | AnnotationsNode | ArgumentsNode | ArrayNode | AssignmentNode | AttributeNode | AttributeCallNode | AttributeSubscriptNode | AugmentedAssignmentNode | AwaitExpressionNode | BaseCallNode | BinaryOperatorNode | BodyNode | BreakStatementNode | CallNode | ClassBodyNode | ClassDefinitionNode | ClassNameStatementNode | ConditionalExpressionNode | ConstStatementNode | ConstructorDefinitionNode | ContinueStatementNode | DefaultParameterNode | DictionaryNode | ElifClauseNode | ElseClauseNode | EnumDefinitionNode | EnumeratorNode | EnumeratorListNode | ExportVariableStatementNode | ExpressionStatementNode | ExtendsStatementNode | ForStatementNode | FunctionDefinitionNode | GetBodyNode | GetNodeNode | GetterNode | IdentifierNode | IfStatementNode | InferredTypeNode | LambdaNode | MatchBodyNode | MatchStatementNode | NameNode | NodePathNode | OnreadyVariableStatementNode | PairNode | ParametersNode | ParenthesizedExpressionNode | PassStatementNode | PatternBindingNode | PatternGuardNode | PatternSectionNode | RegionStartNode | RemoteKeywordNode | ReturnStatementNode | SetBodyNode | SetgetNode | SetterNode | SignalStatementNode | SourceNode | StringNode | StringNameNode | SubscriptNode | SubscriptArgumentsNode | TypeNode | TypedDefaultParameterNode | TypedParameterNode | UnaryOperatorNode | UnnamedNode<"value"> | VariableStatementNode | VariadicParameterNode | WhileStatementNode | UnnamedNode<"!"> | UnnamedNode<"!="> | UnnamedNode<"\""> | UnnamedNode<"#region"> | UnnamedNode<"$"> | UnnamedNode<"%"> | UnnamedNode<"%="> | UnnamedNode<"&"> | UnnamedNode<"&\""> | UnnamedNode<"&&"> | UnnamedNode<"&="> | UnnamedNode<"("> | UnnamedNode<")"> | UnnamedNode<"*"> | UnnamedNode<"**"> | UnnamedNode<"**="> | UnnamedNode<"*="> | UnnamedNode<"+"> | UnnamedNode<"+="> | UnnamedNode<","> | UnnamedNode<"-"> | UnnamedNode<"-="> | UnnamedNode<"->"> | UnnamedNode<"."> | UnnamedNode<"..."> | UnnamedNode<"/"> | UnnamedNode<"/="> | UnnamedNode<":"> | UnnamedNode<":="> | UnnamedNode<";"> | UnnamedNode<"<"> | UnnamedNode<"<<"> | UnnamedNode<"<<="> | UnnamedNode<"<="> | UnnamedNode<"="> | UnnamedNode<"=="> | UnnamedNode<">"> | UnnamedNode<">="> | UnnamedNode<">>"> | UnnamedNode<">>="> | UnnamedNode<"@"> | UnnamedNode<"["> | UnnamedNode<"]"> | UnnamedNode<"^"> | UnnamedNode<"^\""> | UnnamedNode<"^="> | UnnamedNode<"_init"> | UnnamedNode<"and"> | UnnamedNode<"as"> | UnnamedNode<"await"> | UnnamedNode<"break"> | BreakpointStatementNode | UnnamedNode<"class"> | UnnamedNode<"class_name"> | CommentNode | UnnamedNode<"const"> | UnnamedNode<"continue"> | UnnamedNode<"elif"> | UnnamedNode<"else"> | UnnamedNode<"enum"> | EscapeSequenceNode | UnnamedNode<"export"> | UnnamedNode<"extends"> | FalseNode | FloatNode | UnnamedNode<"for"> | UnnamedNode<"func"> | UnnamedNode<"get"> | UnnamedNode<"if"> | UnnamedNode<"in"> | IntegerNode | UnnamedNode<"is"> | LineContinuationNode | UnnamedNode<"master"> | UnnamedNode<"mastersync"> | UnnamedNode<"match"> | UnnamedNode<"not"> | NullNode | UnnamedNode<"onready"> | UnnamedNode<"or"> | UnnamedNode<"pass"> | PatternOpenEndingNode | UnnamedNode<"puppet"> | UnnamedNode<"puppetsync"> | RegionEndNode | RegionLabelNode | UnnamedNode<"remote"> | UnnamedNode<"remotesync"> | UnnamedNode<"return"> | UnnamedNode<"set"> | UnnamedNode<typeof SyntaxType.Setget> | UnnamedNode<"signal"> | StaticKeywordNode | TrueNode | UnnamedNode<"var"> | UnnamedNode<"when"> | UnnamedNode<"while"> | UnnamedNode<"{"> | UnnamedNode<"|"> | UnnamedNode<"|="> | UnnamedNode<"||"> | UnnamedNode<"}"> | UnnamedNode<"~"> | ErrorNode;
export type AttributeExpressionNode = ArrayNode | BaseCallNode | BinaryOperatorNode | CallNode | DictionaryNode | FalseNode | FloatNode | GetNodeNode | IdentifierNode | IntegerNode | NodePathNode | NullNode | ParenthesizedExpressionNode | StringNode | SubscriptNode | TrueNode | UnaryOperatorNode;
export type CompoundStatementNode = ClassDefinitionNode | ConstructorDefinitionNode | EnumDefinitionNode | ForStatementNode | FunctionDefinitionNode | IfStatementNode | MatchStatementNode | WhileStatementNode;
export type ExpressionNode = PrimaryExpressionNode | ConditionalExpressionNode;
export type ParameterChildNode = DefaultParameterNode | IdentifierNode | TypedDefaultParameterNode | TypedParameterNode | VariadicParameterNode;
export type PatternNode = PrimaryExpressionNode | ConditionalExpressionNode | PatternBindingNode;
export type PrimaryExpressionNode = ArrayNode | AttributeNode | AwaitExpressionNode | BaseCallNode | BinaryOperatorNode | CallNode | DictionaryNode | FalseNode | FloatNode | GetNodeNode | IdentifierNode | IntegerNode | NodePathNode | NullNode | ParenthesizedExpressionNode | StringNode | StringNameNode | SubscriptNode | TrueNode | UnaryOperatorNode;
