...
import { generateTypings } from "../typings/scenes.js";
import { resolveConfig } from "../config/index.js";
import { ProjectCache } from "../cache/index.js";
import { debugLog, resolveFiles } from "./helpers.js";
export function registerGenerateTypingsCommand(program) {
    program
        .command('generate-typings')
        .description('Generate globals.d.ts with class declarations, scene overloads, GodotResources, and autoloads. If no files given, scans tsDir.')
