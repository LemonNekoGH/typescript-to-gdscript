 ...
 */
export function unlabeledBreakTarget(node) {
    if (node.label)
        return undefined;
 ...
 */
export function isLabeledJump(node) {
 ...
 */
export function isSwitchBreak(node) {
 ...
 */
export function emitStatements(t, statements, pos, trailing) {
