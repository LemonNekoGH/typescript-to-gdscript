 ...
 */
export function collectTsDiagnostics(program, tsDir) {
    ...
    for (const sf of program.getSourceFiles()) {
        ...
        if (filePath.endsWith('.d.ts'))
            continue;
        if (!filePath.startsWith(normalizedTsDir))
            continue;
        const diags = [
...
//# sourceMappingURL=ts-diagnostics.js.map